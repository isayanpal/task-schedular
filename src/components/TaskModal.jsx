...
function TaskModal({ open, onClose, task }) {
    ...
    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm" PaperProps={{ style: { borderRadius: 8 } }}>
                <DialogTitle sx={{ fontWeight: 600, color: '#3f51b5', padding: '16px 24px' }}>
                ...
                <DialogActions sx={{ padding: '16px 24px' }}>
                    ...
                    <Button onClick={handleSave} variant="contained" color="primary" sx={{ fontWeight: 500, borderRadius: 1 }}>
                        Save Task
                    </Button>
                </DialogActions>
            </Dialog>
